<?php
    // Pertemuan7 - Belajar Membuat Setter dan Getter (Accessor Method)
    ...
    $produk1->setPenulis("Eiichiro Oda"); // Set digunakan buat set up
    echo $produk1->getPenulis(); //Get digunakan buat nampilin nilai nya atau mengirim ke object
?>